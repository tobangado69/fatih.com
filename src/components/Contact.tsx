...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-zinc-100 border-gray-200 border-t">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-lg">
              ...
              design system consulting, I&apos;m here to help bring your vision to
              life.
            </p>

            <div className="space-y-4 mb-8">
              {[
                { icon: "M", label: "Email", value: "alex@designstudio.com" },
                { icon: "C", label: "Availability", value: "Open for Q3 2025" },
                { icon: "L", label: "Based in", value: "San Francisco, CA (Remote)" },
              ].map((item, i) => (
              ...
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  <div className="w-16 h-16 rounded-full bg-green-100 flex items-center justify-center mb-4">
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2"><path d="M20 6 9 17l-5-5"/></svg>
                  </div>
